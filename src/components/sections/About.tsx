        ...
        <section id="about" className="py-20 bg-white dark:bg-dark-900">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                ...
                >
                    ...
                    <p className="text-dark-600 dark:text-dark-300 max-w-3xl mx-auto">Get to know more about me, my background, and what I do.</p>
                </motion.div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    <motion.div initial={{ opacity: 0, x: -50 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true, margin: "-100px" }} transition={{ duration: 0.5 }}>
                        ...
                        <p className="text-dark-600 dark:text-dark-300 mb-4 leading-relaxed">
                            I&apos;m a passionate full-stack developer with over 3.5 years of experience in building web applications. My journey in tech began with a strong
                            foundation in computer science, and I quickly developed a love for creating elegant solutions to complex problems.
                        </p>
                        <p className="text-dark-600 dark:text-dark-300 mb-6 leading-relaxed">
                            I specialize in developing full-stack web applications using modern technologies like Laravel, Next.js, React, Vue, and Docker. I believe in writing
