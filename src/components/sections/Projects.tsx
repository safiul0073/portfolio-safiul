        ...
        <section id="projects" className="py-20 bg-dark-50 dark:bg-dark-800">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                ...
                >
                    ...
                    <p className="text-dark-600 dark:text-dark-300 max-w-3xl mx-auto">A showcase of my recent work and the technologies I&apos;ve been working with.</p>
                </motion.div>
                                        ...
                                        <div className="p-6">
                                            ...
                                            <div className="flex flex-wrap gap-2">
                                                ...
                                                {project.technologies.length > 3 && (
                                                    <span className="text-xs px-2 py-1 bg-dark-700/80 text-white rounded-full">+{project.technologies.length - 3}</span>
                                                )}
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div className="p-6 sm:p-8">
                                    ...
                                    <div className="flex flex-wrap gap-4">
                                        {selectedProject.github !== "#" ? (
                                            ...
                                            <span className="inline-flex items-center px-4 py-2 bg-dark-800 dark:bg-dark-700 hover:bg-dark-700 dark:hover:bg-dark-600 text-white rounded-md transition-colors">
                                                View Code Not Available
                                            </span>
                                        )}
                                        ...
                                        {selectedProject.live !== "#" ? (
                                            ...
                                            <span className="inline-flex items-center px-4 py-2 bg-primary-600 hover:bg-primary-700 text-white rounded-md transition-colors">
